...
export function createSetNameEvent(name: string): SetName {
  let setNameEvent = changetype<SetName>(newMockEvent())

  setNameEvent.parameters = new Array()

  setNameEvent.parameters.push(
...
export function createSetSymbolEvent(symbol: string): SetSymbol {
  let setSymbolEvent = changetype<SetSymbol>(newMockEvent())

  setSymbolEvent.parameters = new Array()

  setSymbolEvent.parameters.push(
    new ethereum.EventParam("symbol", ethereum.Value.fromString(symbol))
  )

  return setSymbolEvent
}
...
export function createUpdateLostAssetsEvent(
  newLostAssets: BigInt
): UpdateLostAssets {
  let updateLostAssetsEvent = changetype<UpdateLostAssets>(newMockEvent())

  updateLostAssetsEvent.parameters = new Array()

  updateLostAssetsEvent.parameters.push(
    new ethereum.EventParam(
      "newLostAssets",
      ethereum.Value.fromUnsignedBigInt(newLostAssets)
    )
  )

  return updateLostAssetsEvent
}
